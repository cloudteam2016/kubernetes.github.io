...
[write a new topic](https://github.com/kubernetes/kubernetes.github.io/docs/contribute/write-new-topic/),
choose the
[page type](https://github.com/kubernetes/kubernetes.github.io/docs/contribute/page-templates/)
